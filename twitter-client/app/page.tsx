        ...
        <div className="col-span-3 px-6">
          ...
          <div className="mt-4 text-lg font-bold">
            <ul>
              ...
              <li key = {item.title} className="flex justify-start items-center gap-4 w-fit mx-4 pl-4 pr-6 py-1 mt-2 rounded-3xl hover:bg-slate-100 cursor-pointer">
                <span>{item.icon}</span>
                <span>{item.title}</span>
                </li>
              ))}
            </ul>
          <button className=" text-lg font-semibold bg-[#1d9bf0] text-white hover:bg-[#1a8cd8] w-full mt-4 p-3 rounded-full">POST</button>
          </div>
        </div>
